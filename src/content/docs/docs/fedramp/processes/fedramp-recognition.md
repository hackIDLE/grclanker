...
Short name: `REC` · Process ID: `REC` · Web slug: `fedramp-recognition`

Applies to: `both`
Status: `stable`


Official page: [https://www.fedramp.gov/2026/reference/fedramp-recognition/](https://www.fedramp.gov/2026/reference/fedramp-recognition/)
